...
<!-- form tạo đề thi -->
			...
			<div class="local" style="margin-top: 10px;">
				...
				<div>
					<div class="row">
						...
						<div class="col-md-3 container image">
						  <img src="images/loc6.jpg" alt="Avatar" class="image" style="margin-left: -16px;margin-top: 0px;width:95px;height: 94px;"> 
						  <div class="overlay">
		...
		<img src="images/login2.png" class="avatar">
			...
			<form action="EditImforForward" method="get" name ="vform">
				<div class="row">
					...
					<div class="col-md-8 textEditIn4" ><input class="require" type="text" name="Ten" id="nameIn4" value="<%=LoginForward.UserName%>" required pattern=""></div>
				</div>
				...
				<div class="row in4users1">
					...
					<div class="col-md-8 textEditIn4"><input value="<%=LoginForward.PhoneNumber %>" class="require" required type="text" name="SDT" id="phone"></div>
				</div>
				<div class="row in4users1">
					<div class="col-md-2"></div>
					<div class="col-md-2" style="color: white">CMND</div>
					<% String cerLabel1=(String)request.getAttribute("cerLabel"); %>
					<div class="col-md-8 textEditIn4"><input value=<%=LoginForward.Certi %> required pattern="" class="require" type="text" name="CMND" id="cer"></div>
				</div>
				<div class="row in4users1">
					<div class="col-md-2"></div>
					<div class="col-md-2" style="color: white">Nơi công tác</div>
					<% String addrLabel1=(String)request.getAttribute("addrLabel"); %>
					<div class="col-md-8 textEditIn4"><input value="<%=LoginForward.Address %>" class="require" type="text" name="NCT" id="addr" required pattern=""></div>
				</div>
				<div class="index">
   						<div class="row">
   							<div class="col-md-10">
 ...
 -->											<!-- </Form> -->
										...
										<div class="col-sm-9">
											<div class="jobs_right">
												...
												<a href="ViewScoreListStudent.jsp?idexam4=<%=c.getExamID()%>" class="fa fa-columns"></a>
													...
													<li><a href="NextQuestionTeacherForward?examID3=<%=c.getExamID()%>"  class="fa fa-building-o"></a></li>
	...
	<div id="formDetailExam"   style="display: block;">
			<h1 id="addExam" style="margin-top: 10px;font-size: 30px;">Chi tiết đề thi</h1>
			<% 
				 String examID=(String)request.getParameter("ExamID7");
				List<DetailExam> lists=new ArrayList<DetailExam>();
				lists=DetailExamDAO.DisplayListDetail(examID);
				int j=0;
				if(lists.size()==0)
				{%>
		...
		<%}%>
			<% int i=0;%>
	<% 	for(DetailExam c:DetailExamDAO.DisplayListDetail(examID))
		{%>
			<% i++; %>
			<%-- <div class="row">
				<div class="col-md-2 detai1 ">Mã đề thi</div>

...
.container:hover .image {
    ...
    -webkit-transform: scale(7,5); /* Safari 3-8 */
    transform: scale(7,5); 
    object-fit: fill;
    z-index: 1000;
...
<!-- form tạo cấu trúc đề thi -->
	...
	<div id="formStructExam" style="display: none">
		<div class="editbox">
		<img src="images/login2.png" class="avatar" onclick="hideformStructExam()">
	...
	<div id="formQuestionExam" style="display: none;">
		<div class="editbox1">
		<img src="images/login2.png" class="avatar" onclick="hideformAddExam1()">
			<h1 id="addExam">Thêm đề thi</h1>
			<div class="local">
				<div class="addExam-title">
					Khởi tạo đề thi
...
<!-- form tạo đề thi -->
				...
				<div>
					<div class="row">
						...
						<div class="col-md-3 container image">
						  <img src="images/LoadExcel.png" alt="Avatar" class="image" style="margin-left: -16px;margin-top: 0px;width:95px;height: 94px;"> 
						   <div class="overlay">
						    <!-- <div class="text">
						...
						<div class="col-sm-9 content-exam">
							<div>
								...
								<a href="AddExamLocalExcel.jsp" class="btnExam buttonExam" onclick="showExam()">Khởi tạo</a>
							</div>
		...
		<img src="images/login2.png" class="avatar">
			...
			<form action="EditImforForward" method="get" name ="vform">
				<div class="row">
					...
					<div class="col-md-8 textEditIn4" ><input style="color: black;" class="require" type="text" name="Ten" id="nameIn4" value="<%=LoginForward.UserName%>" required pattern=""></div>
				</div>
				...
				<div class="row in4users1">
					...
					<div class="col-md-8 textEditIn4"><input style="color: black;" value="<%=LoginForward.PhoneNumber %>" class="require" required type="text" name="SDT" id="phone"></div>
				</div>
				<div class="row in4users1">
					<div class="col-md-2"></div>
					<div class="col-md-2" style="color: white">CMND</div>
					<% String cerLabel1=(String)request.getAttribute("cerLabel"); %>
					<div class="col-md-8 textEditIn4"><input style="color: black;" value=<%=LoginForward.Certi %> required pattern="" class="require" type="text" name="CMND" id="cer"></div>
				</div>
				<div class="row in4users1">
					<div class="col-md-2"></div>
					<div class="col-md-2" style="color: white">Nơi công tác</div>
					<% String addrLabel1=(String)request.getAttribute("addrLabel"); %>
					<div class="col-md-8 textEditIn4"><input  style="color: black;" value="<%=LoginForward.Address %>" class="require" type="text" name="NCT" id="addr" required pattern=""></div>
				</div>
				<div class="index">
   						<div class="row">
   							<div class="col-md-10">
   							...
   							<div class="col-md-2">
   								<button type="submit" class="buttonIndex"style="margin-top: -200px;" >Lưu</button>
   							</div>
   						</div>
		...
		<div class="content_student">
			<div class="col-md-3 menu_info_left">
				<div id="menu">
				 	<ul>
				 		...
				 		<!-- 	<li onclick="showHome()"><a href="#in4mation">QUẢN LÝ BÀI THI</a></li> -->
			...
			<div class="col-md-9 mana_info_right">
				<div class="show_inf_student1">
					...
					<!--QUẢN LÝ ĐỀ THI-->
					<div role="tabpanel" class="tab-pane fade in active" id="home1" id="home" aria-labelledby="home-tab"  style="display: block;">
									 <%String userLogin=(String)request.getParameter("ExamID6");%>
									<% 	for(Exam c:AddExamDAO.DisplayExamTeacher(userLogin))/*  */
										{%>
 ...
 -->											<!-- </Form> -->
 												<%-- <%String idXoa=request.getParameter("examIDXoa"); %> --%>
 												<a href="DeleteExamTeacherForward?idExam=<%=c.getExamID()%>">Đồng ý</a>
 												<a onclick="hideQuestionDelete()" >Thoát</a>
									...
									<div class="tab_grid" >
										<div class="col-sm-3 loc_1">
											<a href="#"><img src="images/thitracnghiem.jpg" style="margin-top:22px;" width="180px" height="180px;" alt=""></a>
										</div>
										<div class="col-sm-9"  style="margin-top: 20px;">
											<div class="jobs_right">
												...
												<div class="read"><a href="DetailExam.jsp?ExamID7=<%=c.getExamID()%>" class="read-more">Chi tiết đề thi</a></div>
												<%-- <div class="read">
												...
												<a title="Danh sách điểm" href="ViewScoreListStudent.jsp?idexam4=<%=c.getExamID()%> " class="fa fa-columns"></a>
													...
													<li><a title="Xóa đề thi" value=<%=c.getExamID()%> name="examIDXoa" class="fa fa-trash-o" onclick="showQuestionDelete()"></a></li>
													  <li><a href="CenterGetIDExamCommentTeacherForward?ExamIDConser=<%=c.getExamID()%>" class="fa fa-group"></a></li>
												</ul>
												<div class="clearfix"> </div>
											</div>
										</div>

...
<!-- script of in4 student -->
	<script type="text/javascript">
		function showformIn4()
		{
			...
			document.getElementById("formConservation").style.display="none";
...
<!-- form tạo đề thi -->
 ...
 -->											<!-- </Form> -->
				...
				<div class="show_inf_student" id="formConservation" style="display: block;">
					...
					<div class="cmt_student">
						...
						<form action="CommentTeacherForward" method="get">
							...
							<input type="text" name="conserID"value=<%=id %> style="display: none;">
								<textarea name="CommentTeacher" rows="4" cols="25" id="textarea" style="color:black;"></textarea>
								<div class="btn_cmt">
